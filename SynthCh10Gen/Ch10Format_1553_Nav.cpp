...
// Move the part before this. The 1553 message index needs to be passed in.
        ...
        "B-" << TmatsIndex.iBIndex << "\\MN\\N-1-1:14;\n"
    ...
    ssTMATS <<
        ...
        "C-" << TmatsIndex.iCIndex << "\\MN3:knots;\n"
        "C-" << TmatsIndex.iCIndex << "\\MN4:OTH;\n"
        ...
        "C-" << TmatsIndex.iCIndex << "\\DP-1:Velocity X;\n"
        "C-" << TmatsIndex.iCIndex << "\\DP-2:Velocity Y;\n"
        "C-" << TmatsIndex.iCIndex << "\\DPC\\N:0;\n";
    TmatsIndex.iCIndex++;
