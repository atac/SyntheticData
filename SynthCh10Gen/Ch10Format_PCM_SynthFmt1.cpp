...
ClCh10Format_PCM_SynthFmt1::ClCh10Format_PCM_SynthFmt1(float fFrameRate, string stateFieldPrefix)
    {
...
void ClCh10Format_PCM_SynthFmt1::FormatMsg(ClSimState* pclSimState)
{
  ...
  suPcmFrame_Fmt1.iVRTG = int16_t(G2FPS2(pclSimState->fState[(i++)->getID()]));
...
void ClCh10Format_PCM_SynthFmt1::InitFieldSet(string prefix)
{
  ...
  fields.addField(FieldDescriptor("AC_TAS", FieldType::INTEGER_FIELD));
  ...
  fields.addField(FieldDescriptor("AC_AOA", FieldType::INTEGER_FIELD));
  ...
  fields.addField(FieldDescriptor("PLA_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("PLA_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("EGT_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("EGT_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("OIT_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("OIT_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("FF_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("FF_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("N1_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("N1_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("N2_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("N2_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("VIB_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("VIB_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("OIP_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("OIP_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("AOA1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("AOA2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("WOW", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("LGDN", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("LGUP", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("AIL_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("AIL_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("ELEV_1", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("ELEV_2", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("RUDD", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("CWPC", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("CWPF", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("CCPC", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("CCPF", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("RUDP", FieldType::INTEGER_FIELD));
  fields.addField(FieldDescriptor("FLAP", FieldType::INTEGER_FIELD));
